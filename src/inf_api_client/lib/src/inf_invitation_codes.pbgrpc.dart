...
class InfInvitationCodesClient extends Client {
  ...
  InfInvitationCodesClient(ClientChannel channel, {CallOptions options})
...
abstract class InfInvitationCodesServiceBase extends Service {
  String get $name => 'api.InfInvitationCodes';
