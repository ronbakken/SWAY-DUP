  ...
  Future<List<Proposal>> loadProposalMockData() async {
    return [
      Proposal(
        ...
        lastTimeUpdated: DateTime.now().subtract(const Duration(minutes: 10)),
      ...
      Proposal(
        ...
        offerId: 2,
        offerTitle: 'Car Wash',
        lastTimeUpdated: DateTime.now().subtract(const Duration(hours: 5)),
      ...
      Proposal(
        ...
        offerId: 1,
        offerTitle: 'Spoon Ice Tea',
        lastTimeUpdated: DateTime.now().subtract(const Duration(days: 2)),
