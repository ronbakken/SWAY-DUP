...
class LocationServiceMock implements LocationService {
  ...
  @override
	Stream<Coordinate> get onLocationChanged => _onLocationChangedController.stream;

  final StreamController<Coordinate> _onLocationChangedController = new StreamController.broadcast();
