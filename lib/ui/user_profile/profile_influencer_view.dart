      ...
      children: [
        ...
        Padding(
          ...
          child: Column(
            ...
            crossAxisAlignment: CrossAxisAlignment.stretch,
            children: [
              Text('ABOUT ${user.name.toUpperCase()}',textAlign: TextAlign.start, style: AppTheme.textStyleformfieldLabel,),
              SizedBox(height: 8.0,),
              Text(user.description),
              SizedBox(height: 16.0,),
              Container(height: 1, color: AppTheme.white12,),
              SizedBox(height: 16.0,),
              Text('MIN FEE',textAlign: TextAlign.start, style: AppTheme.textStyleformfieldLabel,),
              SizedBox(height: 8.0,),
