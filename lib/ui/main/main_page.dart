    ...
    return Container(
      ...
      child: Column(
        children: <Widget>[
          ...
          SizedBox(height: 10),
          buildMenuRow(Vectors.proposalIcon, 'Browse', () {}),
          SizedBox(height: 10),
          buildMenuRow(Vectors.proposalIcon, 'History', () {}),
          SizedBox(height: 10),
          buildMenuRow(Vectors.proposalIcon, 'Offers', () {}, CircleAvatar(radius: 8.0)),
          SizedBox(height: 10),
          buildMenuRow(Vectors.proposalIcon, 'Direct', () {}),
          SizedBox(height: 10),
          buildMenuRow(Vectors.proposalIcon, 'Deal', () {}),
        ],
      ),
    );
  }
