...
/// {@tool sample}
///
/// This sample shows how to use a [InfSwitch] in a [ListTile]. The
...
class InfSwitch extends StatefulWidget {
  ...
  @override
  _InfSwitchState createState() => _InfSwitchState();
...
class _InfSwitchState extends State<InfSwitch> with TickerProviderStateMixin {
  @override
...
const Color _kTrackColor = AppTheme.white12;
...
class _RenderCupertinoSwitch extends RenderConstrainedBox {
  ...
  final  _thumbPainter = InfThumbPainter();
  ...
  void paint(PaintingContext context, Offset offset) {
    ...
    final double currentThumbExtension = InfThumbPainter.extension * currentReactionValue;
    final double thumbLeft = lerpDouble(
      trackRect.left + _kTrackInnerStart - InfThumbPainter.radius,
      trackRect.left + _kTrackInnerEnd - InfThumbPainter.radius - currentThumbExtension,
      visualPosition,
    );
    final double thumbRight = lerpDouble(
      trackRect.left + _kTrackInnerStart + InfThumbPainter.radius + currentThumbExtension,
      trackRect.left + _kTrackInnerEnd + InfThumbPainter.radius,
      visualPosition,
    );
    ...
    _thumbPainter.paint(canvas, Rect.fromLTRB(
      thumbLeft,
      thumbCenterY - InfThumbPainter.radius,
      thumbRight,
      thumbCenterY + InfThumbPainter.radius,
    ));
  }
